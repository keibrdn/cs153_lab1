...
80100bd4:	0f 84 5a 01 00 00    	je     80100d34 <exec+0x394>
...
80100cfc:	8b 77 0c             	mov    0xc(%edi),%esi
  curproc->tf->eip = elf.entry;  // main
80100cff:	8b 47 20             	mov    0x20(%edi),%eax
  curproc->pgdir = pgdir;
80100d02:	89 4f 0c             	mov    %ecx,0xc(%edi)
  curproc->sz = sz;
80100d05:	8b 8d e8 fe ff ff    	mov    -0x118(%ebp),%ecx
80100d0b:	89 4f 08             	mov    %ecx,0x8(%edi)
  curproc->tf->eip = elf.entry;  // main
80100d0e:	8b 95 3c ff ff ff    	mov    -0xc4(%ebp),%edx
80100d14:	89 50 38             	mov    %edx,0x38(%eax)
  curproc->tf->esp = sp;
80100d17:	8b 47 20             	mov    0x20(%edi),%eax
80100d1a:	89 58 44             	mov    %ebx,0x44(%eax)
  switchuvm(curproc);
80100d1d:	89 3c 24             	mov    %edi,(%esp)
80100d20:	e8 6b 5a 00 00       	call   80106790 <switchuvm>
  freevm(oldpgdir);
80100d25:	89 34 24             	mov    %esi,(%esp)
80100d28:	e8 c3 5d 00 00       	call   80106af0 <freevm>
  return 0;
80100d2d:	31 c0                	xor    %eax,%eax
80100d2f:	e9 de fc ff ff       	jmp    80100a12 <exec+0x72>
  for(argc = 0; argv[argc]; argc++) {
80100d34:	8b 9d e8 fe ff ff    	mov    -0x118(%ebp),%ebx
80100d3a:	31 d2                	xor    %edx,%edx
80100d3c:	8d 8d 58 ff ff ff    	lea    -0xa8(%ebp),%ecx
80100d42:	e9 17 ff ff ff       	jmp    80100c5e <exec+0x2be>
...
80101c9e:	8b 70 70             	mov    0x70(%eax),%esi
  acquire(&icache.lock);
...
80101eec:	e8 6f e4 ff ff       	call   80100360 <panic>
    panic("dirlink");
80101ef1:	c7 04 24 8e 75 10 80 	movl   $0x8010758e,(%esp)
...
80103345:	8b 40 2c             	mov    0x2c(%eax),%eax
...
80103441:	8b 48 2c             	mov    0x2c(%eax),%ecx
...
801034ec:	74 7a                	je     80103568 <allocproc+0xa8>
    if(p->state == UNUSED)
801034ee:	8b 43 14             	mov    0x14(%ebx),%eax
...
801034fa:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
  p->state = EMBRYO;
80103501:	c7 43 14 01 00 00 00 	movl   $0x1,0x14(%ebx)
  p->pid = nextpid++;
80103508:	8d 50 01             	lea    0x1(%eax),%edx
8010350b:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
80103511:	89 43 18             	mov    %eax,0x18(%ebx)
  release(&ptable.lock);
80103514:	e8 67 0e 00 00       	call   80104380 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
80103519:	e8 82 ef ff ff       	call   801024a0 <kalloc>
8010351e:	85 c0                	test   %eax,%eax
80103520:	89 43 10             	mov    %eax,0x10(%ebx)
...
8010352b:	05 9c 0f 00 00       	add    $0xf9c,%eax
  sp -= sizeof *p->tf;
80103530:	89 53 20             	mov    %edx,0x20(%ebx)
  *(uint*)sp = (uint)trapret;
80103533:	c7 40 14 ef 55 10 80 	movl   $0x801055ef,0x14(%eax)
...
8010354a:	89 04 24             	mov    %eax,(%esp)
  p->context = (struct context*)sp;
8010354d:	89 43 24             	mov    %eax,0x24(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103550:	e8 7b 0e 00 00       	call   801043d0 <memset>
  p->context->eip = (uint)forkret;
80103555:	8b 43 24             	mov    0x24(%ebx),%eax
...
8010357b:	c3                   	ret    
    p->state = UNUSED;
8010357c:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
    return 0;
...
801036ea:	89 43 0c             	mov    %eax,0xc(%ebx)
801036ed:	0f 84 d5 00 00 00    	je     801037c8 <userinit+0xf8>
...
80103706:	e8 95 31 00 00       	call   801068a0 <inituvm>
  p->sz = PGSIZE;
8010370b:	c7 43 08 00 10 00 00 	movl   $0x1000,0x8(%ebx)
  memset(p->tf, 0, sizeof(*p->tf));
80103712:	c7 44 24 08 4c 00 00 	movl   $0x4c,0x8(%esp)
80103719:	00 
8010371a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80103721:	00 
80103722:	8b 43 20             	mov    0x20(%ebx),%eax
80103725:	89 04 24             	mov    %eax,(%esp)
80103728:	e8 a3 0c 00 00       	call   801043d0 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
8010372d:	8b 43 20             	mov    0x20(%ebx),%eax
80103730:	ba 1b 00 00 00       	mov    $0x1b,%edx
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103735:	b9 23 00 00 00       	mov    $0x23,%ecx
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
8010373a:	66 89 50 3c          	mov    %dx,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
8010373e:	8b 43 20             	mov    0x20(%ebx),%eax
80103741:	66 89 48 2c          	mov    %cx,0x2c(%eax)
  p->tf->es = p->tf->ds;
80103745:	8b 43 20             	mov    0x20(%ebx),%eax
80103748:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
8010374c:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
80103750:	8b 43 20             	mov    0x20(%ebx),%eax
80103753:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103757:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
8010375b:	8b 43 20             	mov    0x20(%ebx),%eax
8010375e:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
80103765:	8b 43 20             	mov    0x20(%ebx),%eax
80103768:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
8010376f:	8b 43 20             	mov    0x20(%ebx),%eax
80103772:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103779:	8d 43 74             	lea    0x74(%ebx),%eax
8010377c:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80103783:	00 
80103784:	c7 44 24 04 a5 73 10 	movl   $0x801073a5,0x4(%esp)
8010378b:	80 
8010378c:	89 04 24             	mov    %eax,(%esp)
8010378f:	e8 1c 0e 00 00       	call   801045b0 <safestrcpy>
  p->cwd = namei("/");
80103794:	c7 04 24 ae 73 10 80 	movl   $0x801073ae,(%esp)
8010379b:	e8 60 e7 ff ff       	call   80101f00 <namei>
801037a0:	89 43 70             	mov    %eax,0x70(%ebx)
  acquire(&ptable.lock);
801037a3:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801037aa:	e8 61 0b 00 00       	call   80104310 <acquire>
  p->state = RUNNABLE;
801037af:	c7 43 14 03 00 00 00 	movl   $0x3,0x14(%ebx)
  release(&ptable.lock);
801037b6:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801037bd:	e8 be 0b 00 00       	call   80104380 <release>
}
801037c2:	83 c4 14             	add    $0x14,%esp
801037c5:	5b                   	pop    %ebx
801037c6:	5d                   	pop    %ebp
801037c7:	c3                   	ret    
    panic("userinit: out of memory?");
801037c8:	c7 04 24 8c 73 10 80 	movl   $0x8010738c,(%esp)
801037cf:	e8 8c cb ff ff       	call   80100360 <panic>
...
80103879:	8b 43 0c             	mov    0xc(%ebx),%eax
8010387c:	89 04 24             	mov    %eax,(%esp)
8010387f:	e8 cc 33 00 00       	call   80106c50 <copyuvm>
80103884:	85 c0                	test   %eax,%eax
80103886:	89 47 0c             	mov    %eax,0xc(%edi)
80103889:	0f 84 a6 00 00 00    	je     80103935 <fork+0xe5>
  np->sz = curproc->sz;
8010388f:	8b 43 08             	mov    0x8(%ebx),%eax
80103892:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80103895:	89 41 08             	mov    %eax,0x8(%ecx)
  *np->tf = *curproc->tf;
80103898:	8b 79 20             	mov    0x20(%ecx),%edi
8010389b:	89 c8                	mov    %ecx,%eax
  np->parent = curproc;
8010389d:	89 59 1c             	mov    %ebx,0x1c(%ecx)
  *np->tf = *curproc->tf;
801038a0:	8b 73 20             	mov    0x20(%ebx),%esi
801038a3:	b9 13 00 00 00       	mov    $0x13,%ecx
801038a8:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  for(i = 0; i < NOFILE; i++)
801038aa:	31 f6                	xor    %esi,%esi
  np->tf->eax = 0;
801038ac:	8b 40 20             	mov    0x20(%eax),%eax
801038af:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
...
801039d1:	e8 35 0c 00 00       	call   8010460b <swtch>
      switchkvm();
...
801039f7:	e8 84 09 00 00       	call   80104380 <release>
  }
...
80103bdd:	e8 2e 07 00 00       	call   80104310 <acquire>
...
80103bfa:	e8 81 07 00 00       	call   80104380 <release>
}
80103bff:	c9                   	leave  
80103c00:	c3                   	ret    
...
80103c41:	e8 ca 06 00 00       	call   80104310 <acquire>
    release(lk);
80103c46:	89 34 24             	mov    %esi,(%esp)
80103c49:	e8 32 07 00 00       	call   80104380 <release>
  p->chan = chan;
...
80103c6b:	e8 10 07 00 00       	call   80104380 <release>
    acquire(lk);
...
80103c79:	5d                   	pop    %ebp
    acquire(lk);
80103c7a:	e9 91 06 00 00       	jmp    80104310 <acquire>
80103c7f:	90                   	nop
  p->chan = chan;
...
80103cd4:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
80103cd6:	e8 35 06 00 00       	call   80104310 <acquire>
    havekids = 0;
...
80103d75:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        release(&ptable.lock);
80103d7c:	e8 ff 05 00 00       	call   80104380 <release>
}
...
80103d91:	e8 ea 05 00 00       	call   80104380 <release>
}
...
80103dc1:	e8 4a 05 00 00       	call   80104310 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
...
80103e0b:	5d                   	pop    %ebp
  release(&ptable.lock);
80103e0c:	e9 6f 05 00 00       	jmp    80104380 <release>
...
80103e31:	e8 da 04 00 00       	call   80104310 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103e65:	e8 16 05 00 00       	call   80104380 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80103e8f:	e8 ec 04 00 00       	call   80104380 <release>
}
...
80103eb4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103eb8:	c7 04 24 bf 77 10 80 	movl   $0x801077bf,(%esp)
...
80103f2f:	e8 8c 02 00 00       	call   801041c0 <getcallerpcs>
...
80103f79:	8b 7d 08             	mov    0x8(%ebp),%edi
  ...
  int havekids, pid;
  struct proc *curproc = myproc();
80103f7c:	e8 1f f7 ff ff       	call   801036a0 <myproc>
  
  acquire(&ptable.lock);
80103f81:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
  struct proc *curproc = myproc();
80103f88:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  acquire(&ptable.lock);
80103f8b:	e8 80 03 00 00       	call   80104310 <acquire>
  for(;;){
    // Scan through table looking for exited children.
    havekids = 0;
80103f90:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f92:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103f97:	eb 15                	jmp    80103fae <waitpid+0x3e>
80103f99:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103fa0:	81 c3 84 00 00 00    	add    $0x84,%ebx
80103fa6:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80103fac:	74 20                	je     80103fce <waitpid+0x5e>
      if(p->pid!= processID)
80103fae:	8b 73 18             	mov    0x18(%ebx),%esi
80103fb1:	39 fe                	cmp    %edi,%esi
80103fb3:	75 eb                	jne    80103fa0 <waitpid+0x30>
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
80103fb5:	83 7b 14 05          	cmpl   $0x5,0x14(%ebx)
80103fb9:	74 3d                	je     80103ff8 <waitpid+0x88>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fbb:	81 c3 84 00 00 00    	add    $0x84,%ebx
      havekids = 1;
80103fc1:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fc6:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80103fcc:	75 e0                	jne    80103fae <waitpid+0x3e>
        return pid;
      }
    }
...
80103fd0:	0f 84 7c 00 00 00    	je     80104052 <waitpid+0xe2>
80103fd6:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80103fd9:	8b 40 2c             	mov    0x2c(%eax),%eax
80103fdc:	85 c0                	test   %eax,%eax
80103fde:	75 72                	jne    80104052 <waitpid+0xe2>
      release(&ptable.lock);
      return -1;
    }
    ...
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
80103fe0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80103fe3:	c7 44 24 04 20 2d 11 	movl   $0x80112d20,0x4(%esp)
80103fea:	80 
80103feb:	89 04 24             	mov    %eax,(%esp)
80103fee:	e8 1d fc ff ff       	call   80103c10 <sleep>
  }
80103ff3:	eb 9b                	jmp    80103f90 <waitpid+0x20>
80103ff5:	8d 76 00             	lea    0x0(%esi),%esi
        kfree(p->kstack);
80103ff8:	8b 43 10             	mov    0x10(%ebx),%eax
80103ffb:	89 04 24             	mov    %eax,(%esp)
80103ffe:	e8 ed e2 ff ff       	call   801022f0 <kfree>
        freevm(p->pgdir);
80104003:	8b 43 0c             	mov    0xc(%ebx),%eax
        p->kstack = 0;
80104006:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        freevm(p->pgdir);
8010400d:	89 04 24             	mov    %eax,(%esp)
80104010:	e8 db 2a 00 00       	call   80106af0 <freevm>
        release(&ptable.lock);
80104015:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
        p->pid = 0;
8010401c:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
        p->parent = 0;
80104023:	c7 43 1c 00 00 00 00 	movl   $0x0,0x1c(%ebx)
        p->name[0] = 0;
8010402a:	c6 43 74 00          	movb   $0x0,0x74(%ebx)
        p->killed = 0;
8010402e:	c7 43 2c 00 00 00 00 	movl   $0x0,0x2c(%ebx)
        p->state = UNUSED;
80104035:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->exitStatus = 0;
8010403c:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
        release(&ptable.lock);
80104043:	e8 38 03 00 00       	call   80104380 <release>
}
80104048:	83 c4 1c             	add    $0x1c,%esp
8010404b:	89 f0                	mov    %esi,%eax
8010404d:	5b                   	pop    %ebx
8010404e:	5e                   	pop    %esi
8010404f:	5f                   	pop    %edi
80104050:	5d                   	pop    %ebp
...
80104059:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
8010405e:	e8 1d 03 00 00       	call   80104380 <release>
      return -1;
80104063:	eb e3                	jmp    80104048 <waitpid+0xd8>
80104065:	66 90                	xchg   %ax,%ax
80104067:	66 90                	xchg   %ax,%ax
...
8010407a:	c7 44 24 04 98 74 10 	movl   $0x80107498,0x4(%esp)
80104081:	80 
...
801040d7:	e8 34 fb ff ff       	call   80103c10 <sleep>
  while (lk->locked) {
...
80104136:	e8 75 fc ff ff       	call   80103db0 <wakeup>
  release(&lk->lk);
...
80104177:	3b 58 18             	cmp    0x18(%eax),%ebx
...
801042a9:	c3                   	ret    
    panic("popcli");
801042aa:	c7 04 24 ba 74 10 80 	movl   $0x801074ba,(%esp)
801042b1:	e8 aa c0 ff ff       	call   80100360 <panic>
    panic("popcli - interruptible");
801042b6:	c7 04 24 a3 74 10 80 	movl   $0x801074a3,(%esp)
...
80104364:	c3                   	ret    
    panic("acquire");
80104365:	c7 04 24 c1 74 10 80 	movl   $0x801074c1,(%esp)
...
801043b2:	e9 a9 fe ff ff       	jmp    80104260 <popcli>
    panic("release");
801043b7:	c7 04 24 c9 74 10 80 	movl   $0x801074c9,(%esp)
...
80104632:	39 d8                	cmp    %ebx,%eax
80104634:	76 1a                	jbe    80104650 <fetchint+0x30>
80104636:	8d 53 04             	lea    0x4(%ebx),%edx
80104639:	39 d0                	cmp    %edx,%eax
8010463b:	72 13                	jb     80104650 <fetchint+0x30>
    return -1;
  *ip = *(int*)(addr);
8010463d:	8b 45 0c             	mov    0xc(%ebp),%eax
80104640:	8b 13                	mov    (%ebx),%edx
...
80104655:	eb ef                	jmp    80104646 <fetchint+0x26>
...
8010466a:	e8 31 f0 ff ff       	call   801036a0 <myproc>
  ...
  if(addr >= curproc->sz)
8010466f:	39 58 08             	cmp    %ebx,0x8(%eax)
80104672:	76 28                	jbe    8010469c <fetchstr+0x3c>
    return -1;
  *pp = (char*)addr;
80104674:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80104677:	89 da                	mov    %ebx,%edx
80104679:	89 19                	mov    %ebx,(%ecx)
  ep = (char*)curproc->sz;
8010467b:	8b 40 08             	mov    0x8(%eax),%eax
  for(s = *pp; s < ep; s++){
8010467e:	39 c3                	cmp    %eax,%ebx
80104680:	73 1a                	jae    8010469c <fetchstr+0x3c>
    if(*s == 0)
80104682:	80 3b 00             	cmpb   $0x0,(%ebx)
80104685:	75 0e                	jne    80104695 <fetchstr+0x35>
80104687:	eb 1f                	jmp    801046a8 <fetchstr+0x48>
80104689:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104690:	80 3a 00             	cmpb   $0x0,(%edx)
80104693:	74 13                	je     801046a8 <fetchstr+0x48>
  for(s = *pp; s < ep; s++){
80104695:	83 c2 01             	add    $0x1,%edx
80104698:	39 d0                	cmp    %edx,%eax
8010469a:	77 f4                	ja     80104690 <fetchstr+0x30>
      return s - *pp;
  }
  return -1;
}
8010469c:	83 c4 04             	add    $0x4,%esp
    return -1;
...
801046d3:	8b 40 20             	mov    0x20(%eax),%eax
...
8010471f:	8b 46 08             	mov    0x8(%esi),%eax
80104722:	39 c2                	cmp    %eax,%edx
80104724:	73 1a                	jae    80104740 <argptr+0x50>
80104726:	01 d3                	add    %edx,%ebx
80104728:	39 d8                	cmp    %ebx,%eax
8010472a:	72 14                	jb     80104740 <argptr+0x50>
    return -1;
  *pp = (char*)i;
...
80104731:	83 c4 20             	add    $0x20,%esp
  return 0;
...
80104798:	e8 03 ef ff ff       	call   801036a0 <myproc>
  ...
  num = curproc->tf->eax;
8010479d:	8b 70 20             	mov    0x20(%eax),%esi
  struct proc *curproc = myproc();
...
801047a8:	83 fa 18             	cmp    $0x18,%edx
801047ab:	77 1b                	ja     801047c8 <syscall+0x38>
801047ad:	8b 14 85 00 75 10 80 	mov    -0x7fef8b00(,%eax,4),%edx
...
801047c8:	89 44 24 0c          	mov    %eax,0xc(%esp)
            curproc->pid, curproc->name, num);
801047cc:	8d 43 74             	lea    0x74(%ebx),%eax
801047cf:	89 44 24 08          	mov    %eax,0x8(%esp)
    cprintf("%d %s: unknown sys call %d\n",
801047d3:	8b 43 18             	mov    0x18(%ebx),%eax
801047d6:	c7 04 24 d1 74 10 80 	movl   $0x801074d1,(%esp)
801047dd:	89 44 24 04          	mov    %eax,0x4(%esp)
801047e1:	e8 6a be ff ff       	call   80100650 <cprintf>
    curproc->tf->eax = -1;
801047e6:	8b 43 20             	mov    0x20(%ebx),%eax
...
80104810:	8b 4c 90 30          	mov    0x30(%eax,%edx,4),%ecx
...
8010482c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      curproc->ofile[fd] = f;
80104830:	89 5c 90 30          	mov    %ebx,0x30(%eax,%edx,4)
}
...
80104960:	c7 44 24 04 84 75 10 	movl   $0x80107584,0x4(%esp)
80104967:	80 
...
8010497b:	c7 44 24 04 83 75 10 	movl   $0x80107583,0x4(%esp)
80104982:	80 
...
80104991:	79 89                	jns    8010491c <create+0xdc>
      panic("create dots");
80104993:	c7 04 24 77 75 10 80 	movl   $0x80107577,(%esp)
8010499a:	e8 c1 b9 ff ff       	call   80100360 <panic>
    panic("create: dirlink");
8010499f:	c7 04 24 86 75 10 80 	movl   $0x80107586,(%esp)
801049a6:	e8 b5 b9 ff ff       	call   80100360 <panic>
    panic("create: ialloc");
801049ab:	c7 04 24 68 75 10 80 	movl   $0x80107568,(%esp)
...
801049f1:	8b 44 90 30          	mov    0x30(%eax,%edx,4),%eax
...
80104b6d:	c7 44 90 30 00 00 00 	movl   $0x0,0x30(%eax,%edx,4)
80104b74:	00 
  fileclose(f);
...
80104d51:	c7 44 24 04 84 75 10 	movl   $0x80107584,0x4(%esp)
80104d58:	80 
...
80104d69:	c7 44 24 04 83 75 10 	movl   $0x80107583,0x4(%esp)
80104d70:	80 
...
80104ebd:	c7 04 24 a8 75 10 80 	movl   $0x801075a8,(%esp)
80104ec4:	e8 97 b4 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104ec9:	c7 04 24 ba 75 10 80 	movl   $0x801075ba,(%esp)
80104ed0:	e8 8b b4 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104ed5:	c7 04 24 96 75 10 80 	movl   $0x80107596,(%esp)
...
8010516e:	e8 1d c6 ff ff       	call   80101790 <iunlock>
  iput(curproc->cwd);
80105173:	8b 46 70             	mov    0x70(%esi),%eax
...
80105183:	31 c0                	xor    %eax,%eax
  curproc->cwd = ip;
80105185:	89 5e 70             	mov    %ebx,0x70(%esi)
}
...
80105315:	c7 44 98 30 00 00 00 	movl   $0x0,0x30(%eax,%ebx,4)
8010531c:	00 
    fileclose(rf);
...
801053d4:	e8 e7 f2 ff ff       	call   801046c0 <argint>
...
801053e3:	e8 38 ea ff ff       	call   80103e20 <kill>
}
801053e8:	c9                   	leave  
801053e9:	c3                   	ret    
...
80105403:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105406:	e8 95 e2 ff ff       	call   801036a0 <myproc>
...
8010542c:	78 22                	js     80105450 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
8010542e:	e8 6d e2 ff ff       	call   801036a0 <myproc>
  if(growproc(n) < 0)
80105433:	8b 55 f4             	mov    -0xc(%ebp),%edx
  addr = myproc()->sz;
80105436:	8b 58 08             	mov    0x8(%eax),%ebx
  if(growproc(n) < 0)
80105439:	89 14 24             	mov    %edx,(%esp)
8010543c:	e8 9f e3 ff ff       	call   801037e0 <growproc>
80105441:	85 c0                	test   %eax,%eax
80105443:	78 0b                	js     80105450 <sys_sbrk+0x40>
    return -1;
  return addr;
80105445:	89 d8                	mov    %ebx,%eax
}
80105447:	83 c4 24             	add    $0x24,%esp
8010544a:	5b                   	pop    %ebx
8010544b:	5d                   	pop    %ebp
8010544c:	c3                   	ret    
...
80105455:	eb f0                	jmp    80105447 <sys_sbrk+0x37>
...
80105475:	e8 46 f2 ff ff       	call   801046c0 <argint>
8010547a:	85 c0                	test   %eax,%eax
8010547c:	78 7e                	js     801054fc <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
8010547e:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
80105485:	e8 86 ee ff ff       	call   80104310 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010548a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010548d:	8b 1d a0 56 11 80    	mov    0x801156a0,%ebx
  while(ticks - ticks0 < n){
...
801054a0:	c7 44 24 04 60 4e 11 	movl   $0x80114e60,0x4(%esp)
801054a7:	80 
801054a8:	c7 04 24 a0 56 11 80 	movl   $0x801156a0,(%esp)
801054af:	e8 5c e7 ff ff       	call   80103c10 <sleep>
  while(ticks - ticks0 < n){
801054b4:	a1 a0 56 11 80       	mov    0x801156a0,%eax
...
801054c5:	8b 40 2c             	mov    0x2c(%eax),%eax
801054c8:	85 c0                	test   %eax,%eax
801054ca:	74 d4                	je     801054a0 <sys_sleep+0x40>
      release(&tickslock);
801054cc:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
801054d3:	e8 a8 ee ff ff       	call   80104380 <release>
      return -1;
...
801054e4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  release(&tickslock);
801054e8:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
801054ef:	e8 8c ee ff ff       	call   80104380 <release>
}
...
80105514:	83 ec 14             	sub    $0x14,%esp
  ...
  acquire(&tickslock);
80105517:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
8010551e:	e8 ed ed ff ff       	call   80104310 <acquire>
  xticks = ticks;
80105523:	8b 1d a0 56 11 80    	mov    0x801156a0,%ebx
  release(&tickslock);
80105529:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
80105530:	e8 4b ee ff ff       	call   80104380 <release>
  return xticks;
}
...
80105546:	c7 04 24 c9 75 10 80 	movl   $0x801075c9,(%esp)
8010554d:	e8 fe b0 ff ff       	call   80100650 <cprintf>
	return 0;
}
...
80105563:	83 ec 28             	sub    $0x28,%esp
	...
	int* status;
	if (argint(0, &pid) < 0)
80105566:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105569:	89 44 24 04          	mov    %eax,0x4(%esp)
8010556d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105574:	e8 47 f1 ff ff       	call   801046c0 <argint>
80105579:	85 c0                	test   %eax,%eax
8010557b:	78 53                	js     801055d0 <sys_waitpid+0x70>
		return -1;
		
	argptr(1, (void*)&status, sizeof(status));
8010557d:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105580:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80105587:	00 
80105588:	89 44 24 04          	mov    %eax,0x4(%esp)
8010558c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105593:	e8 58 f1 ff ff       	call   801046f0 <argptr>
	if (argint(2, &options) < 0)
80105598:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010559b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010559f:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801055a6:	e8 15 f1 ff ff       	call   801046c0 <argint>
801055ab:	85 c0                	test   %eax,%eax
801055ad:	78 21                	js     801055d0 <sys_waitpid+0x70>
		return -1;
	return waitpid(pid, status, options);
801055af:	8b 45 f0             	mov    -0x10(%ebp),%eax
801055b2:	89 44 24 08          	mov    %eax,0x8(%esp)
801055b6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801055b9:	89 44 24 04          	mov    %eax,0x4(%esp)
801055bd:	8b 45 ec             	mov    -0x14(%ebp),%eax
801055c0:	89 04 24             	mov    %eax,(%esp)
801055c3:	e8 a8 e9 ff ff       	call   80103f70 <waitpid>
}
801055c8:	c9                   	leave  
801055c9:	c3                   	ret    
...
801055e6:	54                   	push   %esp
  call trap
801055e7:	e8 e4 00 00 00       	call   801056d0 <trap>
  addl $4, %esp
...
80105686:	66 a3 a6 50 11 80    	mov    %ax,0x801150a6
  initlock(&tickslock, "time");
8010568c:	e8 0f eb ff ff       	call   801041a0 <initlock>
}
80105691:	c9                   	leave  
80105692:	c3                   	ret    
...
8010574e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
            myproc()->pid, myproc()->name, tf->trapno,
80105751:	83 c6 74             	add    $0x74,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105760:	8b 40 18             	mov    0x18(%eax),%eax
...
80105778:	c7 40 2c 01 00 00 00 	movl   $0x1,0x2c(%eax)
8010577f:	90                   	nop
  }
...
8010578e:	8b 50 2c             	mov    0x2c(%eax),%edx
...
801057a5:	83 78 14 04          	cmpl   $0x4,0x14(%eax)
...
801057b9:	8b 40 2c             	mov    0x2c(%eax),%eax
...
80105a86:	6a 00                	push   $0x0
  jmp alltraps
80105a88:	e9 4a fb ff ff       	jmp    801055d7 <alltraps>
...
80105a8f:	6a 01                	push   $0x1
  jmp alltraps
80105a91:	e9 41 fb ff ff       	jmp    801055d7 <alltraps>
...
80105a98:	6a 02                	push   $0x2
  jmp alltraps
80105a9a:	e9 38 fb ff ff       	jmp    801055d7 <alltraps>
...
80105aa1:	6a 03                	push   $0x3
  jmp alltraps
80105aa3:	e9 2f fb ff ff       	jmp    801055d7 <alltraps>
...
80105aaa:	6a 04                	push   $0x4
  jmp alltraps
80105aac:	e9 26 fb ff ff       	jmp    801055d7 <alltraps>
...
80105ab3:	6a 05                	push   $0x5
  jmp alltraps
80105ab5:	e9 1d fb ff ff       	jmp    801055d7 <alltraps>
...
80105abc:	6a 06                	push   $0x6
  jmp alltraps
80105abe:	e9 14 fb ff ff       	jmp    801055d7 <alltraps>
...
80105ac5:	6a 07                	push   $0x7
  jmp alltraps
80105ac7:	e9 0b fb ff ff       	jmp    801055d7 <alltraps>
...
80105acc:	6a 08                	push   $0x8
  jmp alltraps
80105ace:	e9 04 fb ff ff       	jmp    801055d7 <alltraps>
...
80105ad5:	6a 09                	push   $0x9
  jmp alltraps
80105ad7:	e9 fb fa ff ff       	jmp    801055d7 <alltraps>
...
80105adc:	6a 0a                	push   $0xa
  jmp alltraps
80105ade:	e9 f4 fa ff ff       	jmp    801055d7 <alltraps>
...
80105ae3:	6a 0b                	push   $0xb
  jmp alltraps
80105ae5:	e9 ed fa ff ff       	jmp    801055d7 <alltraps>
...
80105aea:	6a 0c                	push   $0xc
  jmp alltraps
80105aec:	e9 e6 fa ff ff       	jmp    801055d7 <alltraps>
...
80105af1:	6a 0d                	push   $0xd
  jmp alltraps
80105af3:	e9 df fa ff ff       	jmp    801055d7 <alltraps>
...
80105b11:	6a 11                	push   $0x11
  jmp alltraps
80105b13:	e9 bf fa ff ff       	jmp    801055d7 <alltraps>
...
80105b1a:	6a 12                	push   $0x12
  jmp alltraps
80105b1c:	e9 b6 fa ff ff       	jmp    801055d7 <alltraps>
...
80105b23:	6a 13                	push   $0x13
  jmp alltraps
80105b25:	e9 ad fa ff ff       	jmp    801055d7 <alltraps>
...
80105b2c:	6a 14                	push   $0x14
  jmp alltraps
80105b2e:	e9 a4 fa ff ff       	jmp    801055d7 <alltraps>
...
80105b35:	6a 15                	push   $0x15
  jmp alltraps
80105b37:	e9 9b fa ff ff       	jmp    801055d7 <alltraps>
...
80105b3e:	6a 16                	push   $0x16
  jmp alltraps
80105b40:	e9 92 fa ff ff       	jmp    801055d7 <alltraps>
...
80105b47:	6a 17                	push   $0x17
  jmp alltraps
80105b49:	e9 89 fa ff ff       	jmp    801055d7 <alltraps>
...
80105b50:	6a 18                	push   $0x18
  jmp alltraps
80105b52:	e9 80 fa ff ff       	jmp    801055d7 <alltraps>
...
80105b59:	6a 19                	push   $0x19
  jmp alltraps
80105b5b:	e9 77 fa ff ff       	jmp    801055d7 <alltraps>
...
80105b62:	6a 1a                	push   $0x1a
  jmp alltraps
80105b64:	e9 6e fa ff ff       	jmp    801055d7 <alltraps>
...
80105b6b:	6a 1b                	push   $0x1b
  jmp alltraps
80105b6d:	e9 65 fa ff ff       	jmp    801055d7 <alltraps>
...
80105b74:	6a 1c                	push   $0x1c
  jmp alltraps
80105b76:	e9 5c fa ff ff       	jmp    801055d7 <alltraps>
...
80105b7d:	6a 1d                	push   $0x1d
  jmp alltraps
80105b7f:	e9 53 fa ff ff       	jmp    801055d7 <alltraps>
...
80105b86:	6a 1e                	push   $0x1e
  jmp alltraps
80105b88:	e9 4a fa ff ff       	jmp    801055d7 <alltraps>
...
80105b8f:	6a 1f                	push   $0x1f
  jmp alltraps
80105b91:	e9 41 fa ff ff       	jmp    801055d7 <alltraps>
...
80105b98:	6a 20                	push   $0x20
  jmp alltraps
80105b9a:	e9 38 fa ff ff       	jmp    801055d7 <alltraps>
...
80105ba1:	6a 21                	push   $0x21
  jmp alltraps
80105ba3:	e9 2f fa ff ff       	jmp    801055d7 <alltraps>
...
80105baa:	6a 22                	push   $0x22
  jmp alltraps
80105bac:	e9 26 fa ff ff       	jmp    801055d7 <alltraps>
...
80105bb3:	6a 23                	push   $0x23
  jmp alltraps
80105bb5:	e9 1d fa ff ff       	jmp    801055d7 <alltraps>
...
80105bbc:	6a 24                	push   $0x24
  jmp alltraps
80105bbe:	e9 14 fa ff ff       	jmp    801055d7 <alltraps>
...
80105bc5:	6a 25                	push   $0x25
  jmp alltraps
80105bc7:	e9 0b fa ff ff       	jmp    801055d7 <alltraps>
...
80105bce:	6a 26                	push   $0x26
  jmp alltraps
80105bd0:	e9 02 fa ff ff       	jmp    801055d7 <alltraps>
...
80105bd7:	6a 27                	push   $0x27
  jmp alltraps
80105bd9:	e9 f9 f9 ff ff       	jmp    801055d7 <alltraps>
...
80105be0:	6a 28                	push   $0x28
  jmp alltraps
80105be2:	e9 f0 f9 ff ff       	jmp    801055d7 <alltraps>
...
80105be9:	6a 29                	push   $0x29
  jmp alltraps
80105beb:	e9 e7 f9 ff ff       	jmp    801055d7 <alltraps>
...
80105bf2:	6a 2a                	push   $0x2a
  jmp alltraps
80105bf4:	e9 de f9 ff ff       	jmp    801055d7 <alltraps>
...
80105bfb:	6a 2b                	push   $0x2b
  jmp alltraps
80105bfd:	e9 d5 f9 ff ff       	jmp    801055d7 <alltraps>
...
80105c04:	6a 2c                	push   $0x2c
  jmp alltraps
80105c06:	e9 cc f9 ff ff       	jmp    801055d7 <alltraps>
...
80105c0d:	6a 2d                	push   $0x2d
  jmp alltraps
80105c0f:	e9 c3 f9 ff ff       	jmp    801055d7 <alltraps>
...
80105c16:	6a 2e                	push   $0x2e
  jmp alltraps
80105c18:	e9 ba f9 ff ff       	jmp    801055d7 <alltraps>
...
80105c1f:	6a 2f                	push   $0x2f
  jmp alltraps
80105c21:	e9 b1 f9 ff ff       	jmp    801055d7 <alltraps>
...
80105c28:	6a 30                	push   $0x30
  jmp alltraps
80105c2a:	e9 a8 f9 ff ff       	jmp    801055d7 <alltraps>
...
80105c31:	6a 31                	push   $0x31
  jmp alltraps
80105c33:	e9 9f f9 ff ff       	jmp    801055d7 <alltraps>
...
80105c3a:	6a 32                	push   $0x32
  jmp alltraps
80105c3c:	e9 96 f9 ff ff       	jmp    801055d7 <alltraps>
...
80105c43:	6a 33                	push   $0x33
  jmp alltraps
80105c45:	e9 8d f9 ff ff       	jmp    801055d7 <alltraps>
...
80105c4c:	6a 34                	push   $0x34
  jmp alltraps
80105c4e:	e9 84 f9 ff ff       	jmp    801055d7 <alltraps>
...
80105c55:	6a 35                	push   $0x35
  jmp alltraps
80105c57:	e9 7b f9 ff ff       	jmp    801055d7 <alltraps>
...
80105c5e:	6a 36                	push   $0x36
  jmp alltraps
80105c60:	e9 72 f9 ff ff       	jmp    801055d7 <alltraps>
...
80105c67:	6a 37                	push   $0x37
  jmp alltraps
80105c69:	e9 69 f9 ff ff       	jmp    801055d7 <alltraps>
...
80105c70:	6a 38                	push   $0x38
  jmp alltraps
80105c72:	e9 60 f9 ff ff       	jmp    801055d7 <alltraps>
...
80105c79:	6a 39                	push   $0x39
  jmp alltraps
80105c7b:	e9 57 f9 ff ff       	jmp    801055d7 <alltraps>
...
80105c82:	6a 3a                	push   $0x3a
  jmp alltraps
80105c84:	e9 4e f9 ff ff       	jmp    801055d7 <alltraps>
...
80105c8b:	6a 3b                	push   $0x3b
  jmp alltraps
80105c8d:	e9 45 f9 ff ff       	jmp    801055d7 <alltraps>
...
80105c94:	6a 3c                	push   $0x3c
  jmp alltraps
80105c96:	e9 3c f9 ff ff       	jmp    801055d7 <alltraps>
...
80105c9d:	6a 3d                	push   $0x3d
  jmp alltraps
80105c9f:	e9 33 f9 ff ff       	jmp    801055d7 <alltraps>
...
80105ca6:	6a 3e                	push   $0x3e
  jmp alltraps
80105ca8:	e9 2a f9 ff ff       	jmp    801055d7 <alltraps>
...
80105caf:	6a 3f                	push   $0x3f
  jmp alltraps
80105cb1:	e9 21 f9 ff ff       	jmp    801055d7 <alltraps>
...
80105cb8:	6a 40                	push   $0x40
  jmp alltraps
80105cba:	e9 18 f9 ff ff       	jmp    801055d7 <alltraps>
...
80105cc1:	6a 41                	push   $0x41
  jmp alltraps
80105cc3:	e9 0f f9 ff ff       	jmp    801055d7 <alltraps>
...
80105cca:	6a 42                	push   $0x42
  jmp alltraps
80105ccc:	e9 06 f9 ff ff       	jmp    801055d7 <alltraps>
...
80105cd3:	6a 43                	push   $0x43
  jmp alltraps
80105cd5:	e9 fd f8 ff ff       	jmp    801055d7 <alltraps>
...
80105cdc:	6a 44                	push   $0x44
  jmp alltraps
80105cde:	e9 f4 f8 ff ff       	jmp    801055d7 <alltraps>
...
80105ce5:	6a 45                	push   $0x45
  jmp alltraps
80105ce7:	e9 eb f8 ff ff       	jmp    801055d7 <alltraps>
...
80105cee:	6a 46                	push   $0x46
  jmp alltraps
80105cf0:	e9 e2 f8 ff ff       	jmp    801055d7 <alltraps>
...
80105cf7:	6a 47                	push   $0x47
  jmp alltraps
80105cf9:	e9 d9 f8 ff ff       	jmp    801055d7 <alltraps>
...
80105d00:	6a 48                	push   $0x48
  jmp alltraps
80105d02:	e9 d0 f8 ff ff       	jmp    801055d7 <alltraps>
...
80105d09:	6a 49                	push   $0x49
  jmp alltraps
80105d0b:	e9 c7 f8 ff ff       	jmp    801055d7 <alltraps>
...
80105d12:	6a 4a                	push   $0x4a
  jmp alltraps
80105d14:	e9 be f8 ff ff       	jmp    801055d7 <alltraps>
...
80105d1b:	6a 4b                	push   $0x4b
  jmp alltraps
80105d1d:	e9 b5 f8 ff ff       	jmp    801055d7 <alltraps>
...
80105d24:	6a 4c                	push   $0x4c
  jmp alltraps
80105d26:	e9 ac f8 ff ff       	jmp    801055d7 <alltraps>
...
80105d2d:	6a 4d                	push   $0x4d
  jmp alltraps
80105d2f:	e9 a3 f8 ff ff       	jmp    801055d7 <alltraps>
...
80105d36:	6a 4e                	push   $0x4e
  jmp alltraps
80105d38:	e9 9a f8 ff ff       	jmp    801055d7 <alltraps>
...
80105d3f:	6a 4f                	push   $0x4f
  jmp alltraps
80105d41:	e9 91 f8 ff ff       	jmp    801055d7 <alltraps>
...
80105d48:	6a 50                	push   $0x50
  jmp alltraps
80105d4a:	e9 88 f8 ff ff       	jmp    801055d7 <alltraps>
...
80105d51:	6a 51                	push   $0x51
  jmp alltraps
80105d53:	e9 7f f8 ff ff       	jmp    801055d7 <alltraps>
...
80105d5a:	6a 52                	push   $0x52
  jmp alltraps
80105d5c:	e9 76 f8 ff ff       	jmp    801055d7 <alltraps>
...
80105d63:	6a 53                	push   $0x53
  jmp alltraps
80105d65:	e9 6d f8 ff ff       	jmp    801055d7 <alltraps>
...
80105d6c:	6a 54                	push   $0x54
  jmp alltraps
80105d6e:	e9 64 f8 ff ff       	jmp    801055d7 <alltraps>
...
80105d75:	6a 55                	push   $0x55
  jmp alltraps
80105d77:	e9 5b f8 ff ff       	jmp    801055d7 <alltraps>
...
80105d7e:	6a 56                	push   $0x56
  jmp alltraps
80105d80:	e9 52 f8 ff ff       	jmp    801055d7 <alltraps>
...
80105d87:	6a 57                	push   $0x57
  jmp alltraps
80105d89:	e9 49 f8 ff ff       	jmp    801055d7 <alltraps>
...
80105d90:	6a 58                	push   $0x58
  jmp alltraps
80105d92:	e9 40 f8 ff ff       	jmp    801055d7 <alltraps>
...
80105d99:	6a 59                	push   $0x59
  jmp alltraps
80105d9b:	e9 37 f8 ff ff       	jmp    801055d7 <alltraps>
...
80105da2:	6a 5a                	push   $0x5a
  jmp alltraps
80105da4:	e9 2e f8 ff ff       	jmp    801055d7 <alltraps>
...
80105dab:	6a 5b                	push   $0x5b
  jmp alltraps
80105dad:	e9 25 f8 ff ff       	jmp    801055d7 <alltraps>
...
80105db4:	6a 5c                	push   $0x5c
  jmp alltraps
80105db6:	e9 1c f8 ff ff       	jmp    801055d7 <alltraps>
...
80105dbd:	6a 5d                	push   $0x5d
  jmp alltraps
80105dbf:	e9 13 f8 ff ff       	jmp    801055d7 <alltraps>
...
80105dc6:	6a 5e                	push   $0x5e
  jmp alltraps
80105dc8:	e9 0a f8 ff ff       	jmp    801055d7 <alltraps>
...
80105dcf:	6a 5f                	push   $0x5f
  jmp alltraps
80105dd1:	e9 01 f8 ff ff       	jmp    801055d7 <alltraps>
...
80105dd8:	6a 60                	push   $0x60
  jmp alltraps
80105dda:	e9 f8 f7 ff ff       	jmp    801055d7 <alltraps>
...
80105de1:	6a 61                	push   $0x61
  jmp alltraps
80105de3:	e9 ef f7 ff ff       	jmp    801055d7 <alltraps>
...
80105dea:	6a 62                	push   $0x62
  jmp alltraps
80105dec:	e9 e6 f7 ff ff       	jmp    801055d7 <alltraps>
...
80105df3:	6a 63                	push   $0x63
  jmp alltraps
80105df5:	e9 dd f7 ff ff       	jmp    801055d7 <alltraps>
...
80105dfc:	6a 64                	push   $0x64
  jmp alltraps
80105dfe:	e9 d4 f7 ff ff       	jmp    801055d7 <alltraps>
...
80105e05:	6a 65                	push   $0x65
  jmp alltraps
80105e07:	e9 cb f7 ff ff       	jmp    801055d7 <alltraps>
...
80105e0e:	6a 66                	push   $0x66
  jmp alltraps
80105e10:	e9 c2 f7 ff ff       	jmp    801055d7 <alltraps>
...
80105e17:	6a 67                	push   $0x67
  jmp alltraps
80105e19:	e9 b9 f7 ff ff       	jmp    801055d7 <alltraps>
...
80105e20:	6a 68                	push   $0x68
  jmp alltraps
80105e22:	e9 b0 f7 ff ff       	jmp    801055d7 <alltraps>
...
80105e29:	6a 69                	push   $0x69
  jmp alltraps
80105e2b:	e9 a7 f7 ff ff       	jmp    801055d7 <alltraps>
...
80105e32:	6a 6a                	push   $0x6a
  jmp alltraps
80105e34:	e9 9e f7 ff ff       	jmp    801055d7 <alltraps>
...
80105e3b:	6a 6b                	push   $0x6b
  jmp alltraps
80105e3d:	e9 95 f7 ff ff       	jmp    801055d7 <alltraps>
...
80105e44:	6a 6c                	push   $0x6c
  jmp alltraps
80105e46:	e9 8c f7 ff ff       	jmp    801055d7 <alltraps>
...
80105e4d:	6a 6d                	push   $0x6d
  jmp alltraps
80105e4f:	e9 83 f7 ff ff       	jmp    801055d7 <alltraps>
...
80105e56:	6a 6e                	push   $0x6e
  jmp alltraps
80105e58:	e9 7a f7 ff ff       	jmp    801055d7 <alltraps>
...
80105e5f:	6a 6f                	push   $0x6f
  jmp alltraps
80105e61:	e9 71 f7 ff ff       	jmp    801055d7 <alltraps>
...
80105e68:	6a 70                	push   $0x70
  jmp alltraps
80105e6a:	e9 68 f7 ff ff       	jmp    801055d7 <alltraps>
...
80105e71:	6a 71                	push   $0x71
  jmp alltraps
80105e73:	e9 5f f7 ff ff       	jmp    801055d7 <alltraps>
...
80105e7a:	6a 72                	push   $0x72
  jmp alltraps
80105e7c:	e9 56 f7 ff ff       	jmp    801055d7 <alltraps>
...
80105e83:	6a 73                	push   $0x73
  jmp alltraps
80105e85:	e9 4d f7 ff ff       	jmp    801055d7 <alltraps>
...
80105e8c:	6a 74                	push   $0x74
  jmp alltraps
80105e8e:	e9 44 f7 ff ff       	jmp    801055d7 <alltraps>
...
80105e95:	6a 75                	push   $0x75
  jmp alltraps
80105e97:	e9 3b f7 ff ff       	jmp    801055d7 <alltraps>
...
80105e9e:	6a 76                	push   $0x76
  jmp alltraps
80105ea0:	e9 32 f7 ff ff       	jmp    801055d7 <alltraps>
...
80105ea7:	6a 77                	push   $0x77
  jmp alltraps
80105ea9:	e9 29 f7 ff ff       	jmp    801055d7 <alltraps>
...
80105eb0:	6a 78                	push   $0x78
  jmp alltraps
80105eb2:	e9 20 f7 ff ff       	jmp    801055d7 <alltraps>
...
80105eb9:	6a 79                	push   $0x79
  jmp alltraps
80105ebb:	e9 17 f7 ff ff       	jmp    801055d7 <alltraps>
...
80105ec2:	6a 7a                	push   $0x7a
  jmp alltraps
80105ec4:	e9 0e f7 ff ff       	jmp    801055d7 <alltraps>
...
80105ecb:	6a 7b                	push   $0x7b
  jmp alltraps
80105ecd:	e9 05 f7 ff ff       	jmp    801055d7 <alltraps>
...
80105ed4:	6a 7c                	push   $0x7c
  jmp alltraps
80105ed6:	e9 fc f6 ff ff       	jmp    801055d7 <alltraps>
...
80105edd:	6a 7d                	push   $0x7d
  jmp alltraps
80105edf:	e9 f3 f6 ff ff       	jmp    801055d7 <alltraps>
...
80105ee6:	6a 7e                	push   $0x7e
  jmp alltraps
80105ee8:	e9 ea f6 ff ff       	jmp    801055d7 <alltraps>
...
80105eef:	6a 7f                	push   $0x7f
  jmp alltraps
80105ef1:	e9 e1 f6 ff ff       	jmp    801055d7 <alltraps>
...
80105ef8:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105efd:	e9 d5 f6 ff ff       	jmp    801055d7 <alltraps>
...
80105f04:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105f09:	e9 c9 f6 ff ff       	jmp    801055d7 <alltraps>
...
80105f10:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105f15:	e9 bd f6 ff ff       	jmp    801055d7 <alltraps>
...
80105f1c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105f21:	e9 b1 f6 ff ff       	jmp    801055d7 <alltraps>
...
80105f28:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105f2d:	e9 a5 f6 ff ff       	jmp    801055d7 <alltraps>
...
80105f34:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105f39:	e9 99 f6 ff ff       	jmp    801055d7 <alltraps>
...
80105f40:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105f45:	e9 8d f6 ff ff       	jmp    801055d7 <alltraps>
...
80105f4c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105f51:	e9 81 f6 ff ff       	jmp    801055d7 <alltraps>
...
80105f58:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105f5d:	e9 75 f6 ff ff       	jmp    801055d7 <alltraps>
...
80105f64:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105f69:	e9 69 f6 ff ff       	jmp    801055d7 <alltraps>
...
80105f70:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80105f75:	e9 5d f6 ff ff       	jmp    801055d7 <alltraps>
...
80105f7c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80105f81:	e9 51 f6 ff ff       	jmp    801055d7 <alltraps>
...
80105f88:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80105f8d:	e9 45 f6 ff ff       	jmp    801055d7 <alltraps>
...
80105f94:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80105f99:	e9 39 f6 ff ff       	jmp    801055d7 <alltraps>
...
80105fa0:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80105fa5:	e9 2d f6 ff ff       	jmp    801055d7 <alltraps>
...
80105fac:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80105fb1:	e9 21 f6 ff ff       	jmp    801055d7 <alltraps>
...
80105fb8:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80105fbd:	e9 15 f6 ff ff       	jmp    801055d7 <alltraps>
...
80105fc4:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80105fc9:	e9 09 f6 ff ff       	jmp    801055d7 <alltraps>
...
80105fd0:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80105fd5:	e9 fd f5 ff ff       	jmp    801055d7 <alltraps>
...
80105fdc:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80105fe1:	e9 f1 f5 ff ff       	jmp    801055d7 <alltraps>
...
80105fe8:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80105fed:	e9 e5 f5 ff ff       	jmp    801055d7 <alltraps>
...
80105ff4:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80105ff9:	e9 d9 f5 ff ff       	jmp    801055d7 <alltraps>
...
80106000:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106005:	e9 cd f5 ff ff       	jmp    801055d7 <alltraps>
...
8010600c:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106011:	e9 c1 f5 ff ff       	jmp    801055d7 <alltraps>
...
80106018:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010601d:	e9 b5 f5 ff ff       	jmp    801055d7 <alltraps>
...
80106024:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80106029:	e9 a9 f5 ff ff       	jmp    801055d7 <alltraps>
...
80106030:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106035:	e9 9d f5 ff ff       	jmp    801055d7 <alltraps>
...
8010603c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106041:	e9 91 f5 ff ff       	jmp    801055d7 <alltraps>
...
80106048:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010604d:	e9 85 f5 ff ff       	jmp    801055d7 <alltraps>
...
80106054:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80106059:	e9 79 f5 ff ff       	jmp    801055d7 <alltraps>
...
80106060:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106065:	e9 6d f5 ff ff       	jmp    801055d7 <alltraps>
...
8010606c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106071:	e9 61 f5 ff ff       	jmp    801055d7 <alltraps>
...
80106078:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010607d:	e9 55 f5 ff ff       	jmp    801055d7 <alltraps>
...
80106084:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80106089:	e9 49 f5 ff ff       	jmp    801055d7 <alltraps>
...
80106090:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106095:	e9 3d f5 ff ff       	jmp    801055d7 <alltraps>
...
8010609c:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801060a1:	e9 31 f5 ff ff       	jmp    801055d7 <alltraps>
...
801060a8:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801060ad:	e9 25 f5 ff ff       	jmp    801055d7 <alltraps>
...
801060b4:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801060b9:	e9 19 f5 ff ff       	jmp    801055d7 <alltraps>
...
801060c0:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801060c5:	e9 0d f5 ff ff       	jmp    801055d7 <alltraps>
...
801060cc:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801060d1:	e9 01 f5 ff ff       	jmp    801055d7 <alltraps>
...
801060d8:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801060dd:	e9 f5 f4 ff ff       	jmp    801055d7 <alltraps>
...
801060e4:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801060e9:	e9 e9 f4 ff ff       	jmp    801055d7 <alltraps>
...
801060f0:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801060f5:	e9 dd f4 ff ff       	jmp    801055d7 <alltraps>
...
801060fc:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106101:	e9 d1 f4 ff ff       	jmp    801055d7 <alltraps>
...
80106108:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010610d:	e9 c5 f4 ff ff       	jmp    801055d7 <alltraps>
...
80106114:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106119:	e9 b9 f4 ff ff       	jmp    801055d7 <alltraps>
...
80106120:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106125:	e9 ad f4 ff ff       	jmp    801055d7 <alltraps>
...
8010612c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106131:	e9 a1 f4 ff ff       	jmp    801055d7 <alltraps>
...
80106138:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010613d:	e9 95 f4 ff ff       	jmp    801055d7 <alltraps>
...
80106144:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106149:	e9 89 f4 ff ff       	jmp    801055d7 <alltraps>
...
80106150:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106155:	e9 7d f4 ff ff       	jmp    801055d7 <alltraps>
...
8010615c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106161:	e9 71 f4 ff ff       	jmp    801055d7 <alltraps>
...
80106168:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010616d:	e9 65 f4 ff ff       	jmp    801055d7 <alltraps>
...
80106174:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106179:	e9 59 f4 ff ff       	jmp    801055d7 <alltraps>
...
80106180:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106185:	e9 4d f4 ff ff       	jmp    801055d7 <alltraps>
...
8010618c:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106191:	e9 41 f4 ff ff       	jmp    801055d7 <alltraps>
...
80106198:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010619d:	e9 35 f4 ff ff       	jmp    801055d7 <alltraps>
...
801061a4:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801061a9:	e9 29 f4 ff ff       	jmp    801055d7 <alltraps>
...
801061b0:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801061b5:	e9 1d f4 ff ff       	jmp    801055d7 <alltraps>
...
801061bc:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801061c1:	e9 11 f4 ff ff       	jmp    801055d7 <alltraps>
...
801061c8:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801061cd:	e9 05 f4 ff ff       	jmp    801055d7 <alltraps>
...
801061d4:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801061d9:	e9 f9 f3 ff ff       	jmp    801055d7 <alltraps>
...
801061e0:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801061e5:	e9 ed f3 ff ff       	jmp    801055d7 <alltraps>
...
801061ec:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801061f1:	e9 e1 f3 ff ff       	jmp    801055d7 <alltraps>
...
801061f8:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801061fd:	e9 d5 f3 ff ff       	jmp    801055d7 <alltraps>
...
80106204:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106209:	e9 c9 f3 ff ff       	jmp    801055d7 <alltraps>
...
80106210:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106215:	e9 bd f3 ff ff       	jmp    801055d7 <alltraps>
...
8010621c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106221:	e9 b1 f3 ff ff       	jmp    801055d7 <alltraps>
...
80106228:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010622d:	e9 a5 f3 ff ff       	jmp    801055d7 <alltraps>
...
80106234:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106239:	e9 99 f3 ff ff       	jmp    801055d7 <alltraps>
...
80106240:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106245:	e9 8d f3 ff ff       	jmp    801055d7 <alltraps>
...
8010624c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106251:	e9 81 f3 ff ff       	jmp    801055d7 <alltraps>
...
80106258:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010625d:	e9 75 f3 ff ff       	jmp    801055d7 <alltraps>
...
80106264:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106269:	e9 69 f3 ff ff       	jmp    801055d7 <alltraps>
...
80106270:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106275:	e9 5d f3 ff ff       	jmp    801055d7 <alltraps>
...
8010627c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106281:	e9 51 f3 ff ff       	jmp    801055d7 <alltraps>
...
80106288:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010628d:	e9 45 f3 ff ff       	jmp    801055d7 <alltraps>
...
80106294:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106299:	e9 39 f3 ff ff       	jmp    801055d7 <alltraps>
...
801062a0:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801062a5:	e9 2d f3 ff ff       	jmp    801055d7 <alltraps>
...
801062ac:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801062b1:	e9 21 f3 ff ff       	jmp    801055d7 <alltraps>
...
801062b8:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801062bd:	e9 15 f3 ff ff       	jmp    801055d7 <alltraps>
...
801062c4:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801062c9:	e9 09 f3 ff ff       	jmp    801055d7 <alltraps>
...
801062d0:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801062d5:	e9 fd f2 ff ff       	jmp    801055d7 <alltraps>
...
801062dc:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801062e1:	e9 f1 f2 ff ff       	jmp    801055d7 <alltraps>
...
801062e8:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801062ed:	e9 e5 f2 ff ff       	jmp    801055d7 <alltraps>
...
801062f4:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801062f9:	e9 d9 f2 ff ff       	jmp    801055d7 <alltraps>
...
80106300:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106305:	e9 cd f2 ff ff       	jmp    801055d7 <alltraps>
...
8010630c:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106311:	e9 c1 f2 ff ff       	jmp    801055d7 <alltraps>
...
80106318:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010631d:	e9 b5 f2 ff ff       	jmp    801055d7 <alltraps>
...
80106324:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106329:	e9 a9 f2 ff ff       	jmp    801055d7 <alltraps>
...
80106330:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106335:	e9 9d f2 ff ff       	jmp    801055d7 <alltraps>
...
8010633c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106341:	e9 91 f2 ff ff       	jmp    801055d7 <alltraps>
...
80106348:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010634d:	e9 85 f2 ff ff       	jmp    801055d7 <alltraps>
...
80106354:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106359:	e9 79 f2 ff ff       	jmp    801055d7 <alltraps>
...
80106360:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106365:	e9 6d f2 ff ff       	jmp    801055d7 <alltraps>
...
8010636c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106371:	e9 61 f2 ff ff       	jmp    801055d7 <alltraps>
...
80106378:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010637d:	e9 55 f2 ff ff       	jmp    801055d7 <alltraps>
...
80106384:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106389:	e9 49 f2 ff ff       	jmp    801055d7 <alltraps>
...
80106390:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106395:	e9 3d f2 ff ff       	jmp    801055d7 <alltraps>
...
8010639c:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801063a1:	e9 31 f2 ff ff       	jmp    801055d7 <alltraps>
...
801063a8:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801063ad:	e9 25 f2 ff ff       	jmp    801055d7 <alltraps>
...
801063b4:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801063b9:	e9 19 f2 ff ff       	jmp    801055d7 <alltraps>
...
801063c0:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801063c5:	e9 0d f2 ff ff       	jmp    801055d7 <alltraps>
...
801063cc:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801063d1:	e9 01 f2 ff ff       	jmp    801055d7 <alltraps>
...
801063d8:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801063dd:	e9 f5 f1 ff ff       	jmp    801055d7 <alltraps>
...
801063e4:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801063e9:	e9 e9 f1 ff ff       	jmp    801055d7 <alltraps>
...
801063f0:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801063f5:	e9 dd f1 ff ff       	jmp    801055d7 <alltraps>
...
801063fc:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106401:	e9 d1 f1 ff ff       	jmp    801055d7 <alltraps>
...
80106408:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010640d:	e9 c5 f1 ff ff       	jmp    801055d7 <alltraps>
...
80106414:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106419:	e9 b9 f1 ff ff       	jmp    801055d7 <alltraps>
...
80106420:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106425:	e9 ad f1 ff ff       	jmp    801055d7 <alltraps>
...
8010642c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106431:	e9 a1 f1 ff ff       	jmp    801055d7 <alltraps>
...
80106438:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010643d:	e9 95 f1 ff ff       	jmp    801055d7 <alltraps>
...
80106444:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106449:	e9 89 f1 ff ff       	jmp    801055d7 <alltraps>
...
80106450:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106455:	e9 7d f1 ff ff       	jmp    801055d7 <alltraps>
...
8010645c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106461:	e9 71 f1 ff ff       	jmp    801055d7 <alltraps>
...
80106468:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010646d:	e9 65 f1 ff ff       	jmp    801055d7 <alltraps>
...
80106474:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106479:	e9 59 f1 ff ff       	jmp    801055d7 <alltraps>
...
80106480:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106485:	e9 4d f1 ff ff       	jmp    801055d7 <alltraps>
...
8010648c:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106491:	e9 41 f1 ff ff       	jmp    801055d7 <alltraps>
...
80106498:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010649d:	e9 35 f1 ff ff       	jmp    801055d7 <alltraps>
...
801064a4:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801064a9:	e9 29 f1 ff ff       	jmp    801055d7 <alltraps>
...
801064b0:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801064b5:	e9 1d f1 ff ff       	jmp    801055d7 <alltraps>
...
801064bc:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801064c1:	e9 11 f1 ff ff       	jmp    801055d7 <alltraps>
...
801064c8:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801064cd:	e9 05 f1 ff ff       	jmp    801055d7 <alltraps>
...
801064d4:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801064d9:	e9 f9 f0 ff ff       	jmp    801055d7 <alltraps>
...
801064e0:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801064e5:	e9 ed f0 ff ff       	jmp    801055d7 <alltraps>
...
801064ec:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801064f1:	e9 e1 f0 ff ff       	jmp    801055d7 <alltraps>
...
80106562:	e8 69 de ff ff       	call   801043d0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010683d:	8b 56 10             	mov    0x10(%esi),%edx
...
8010685a:	8b 46 0c             	mov    0xc(%esi),%eax
...
8010686b:	5d                   	pop    %ebp
  popcli();
8010686c:	e9 ef d9 ff ff       	jmp    80104260 <popcli>
...
801068d7:	e8 f4 da ff ff       	call   801043d0 <memset>
...
8010690b:	5d                   	pop    %ebp
  memmove(mem, init, sz);
8010690c:	e9 5f db ff ff       	jmp    80104470 <memmove>
...
80106a23:	e8 a8 d9 ff ff       	call   801043d0 <memset>
...
80106b9b:	e8 30 d8 ff ff       	call   801043d0 <memset>
...
80106c8d:	e8 de d7 ff ff       	call   80104470 <memmove>
...
80106dbc:	e8 af d6 ff ff       	call   80104470 <memmove>
    len -= n;
    buf += n;
