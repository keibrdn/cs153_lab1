...
main(int argc, char *argv[])
{
  ...
  40:	e8 bd 02 00 00       	call   302 <link>
  45:	85 c0                	test   %eax,%eax
  47:	78 13                	js     5c <main+0x5c>
  ...
  5b:	c3                   	ret    
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  5c:	8b 43 08             	mov    0x8(%ebx),%eax
  5f:	89 44 24 0c          	mov    %eax,0xc(%esp)
  63:	8b 43 04             	mov    0x4(%ebx),%eax
  66:	c7 44 24 04 79 07 00 	movl   $0x779,0x4(%esp)
  6d:	00 
  6e:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  75:	89 44 24 08          	mov    %eax,0x8(%esp)
  79:	e8 82 03 00 00       	call   400 <printf>
  7e:	eb c9                	jmp    49 <main+0x49>
