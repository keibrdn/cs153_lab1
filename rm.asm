   ...
   5:	be 01 00 00 00       	mov    $0x1,%esi
{
  ...
  2e:	39 fe                	cmp    %edi,%esi
  30:	74 28                	je     5a <main+0x5a>
    if(unlink(argv[i]) < 0){
  32:	8b 03                	mov    (%ebx),%eax
  34:	89 04 24             	mov    %eax,(%esp)
  37:	e8 d6 02 00 00       	call   312 <unlink>
  3c:	85 c0                	test   %eax,%eax
  3e:	79 e8                	jns    28 <main+0x28>
      printf(2, "rm: %s failed to delete\n", argv[i]);
  40:	8b 03                	mov    (%ebx),%eax
  42:	c7 44 24 04 9a 07 00 	movl   $0x79a,0x4(%esp)
  49:	00 
  ...
  61:	e8 5c 02 00 00       	call   2c2 <exit>
  return 0;
}
  ...
  6f:	c3                   	ret    
    printf(2, "Usage: rm files...\n");
  70:	c7 44 24 04 86 07 00 	movl   $0x786,0x4(%esp)
  77:	00 
  78:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  7f:	e8 9c 03 00 00       	call   420 <printf>
    exit(0);
  84:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8b:	e8 32 02 00 00       	call   2c2 <exit>
  90:	eb c8                	jmp    5a <main+0x5a>
  92:	66 90                	xchg   %ax,%ax
  94:	66 90                	xchg   %ax,%ax
  96:	66 90                	xchg   %ax,%ax
  98:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3b9:	0f b6 92 ba 07 00 00 	movzbl 0x7ba(%edx),%edx
  }while((x /= base) != 0);
 ...
 42e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 54f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 551:	b8 b3 07 00 00       	mov    $0x7b3,%eax
 ...
 611:	a1 44 0a 00 00       	mov    0xa44,%eax
{
 ...
 657:	89 10                	mov    %edx,(%eax)
  freep = p;
 659:	a3 44 0a 00 00       	mov    %eax,0xa44
}
 65e:	5b                   	pop    %ebx
 65f:	5e                   	pop    %esi
 660:	5f                   	pop    %edi
 ...
 67f:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 682:	a3 44 0a 00 00       	mov    %eax,0xa44
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 1d 44 0a 00 00    	mov    0xa44,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6e9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6eb:	3b 15 44 0a 00 00    	cmp    0xa44,%edx
 ...
 71d:	e8 ee fe ff ff       	call   610 <free>
  return freep;
 722:	8b 15 44 0a 00 00    	mov    0xa44,%edx
 ...
 75c:	eb e9                	jmp    747 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 75e:	c7 05 44 0a 00 00 48 	movl   $0xa48,0xa44
 765:	0a 00 00 
    base.s.size = 0;
 768:	ba 48 0a 00 00       	mov    $0xa48,%edx
    base.s.ptr = freep = prevp = &base;
 76d:	c7 05 48 0a 00 00 48 	movl   $0xa48,0xa48
 774:	0a 00 00 
    base.s.size = 0;
 777:	c7 05 4c 0a 00 00 00 	movl   $0x0,0xa4c
 77e:	00 00 00 
