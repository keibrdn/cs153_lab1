   ...
   b:	31 db                	xor    %ebx,%ebx
{
  ...
  56:	e8 a5 01 00 00       	call   200 <memset>
    if(fork() > 0)
  5b:	e8 0a 03 00 00       	call   36a <fork>
  60:	85 c0                	test   %eax,%eax
  62:	0f 8f db 00 00 00    	jg     143 <main+0x143>
  for(i = 0; i < 4; i++)
  ...
  a7:	e8 06 03 00 00       	call   3b2 <open>
...
//    printf(fd, "%d\n", i);
 ...
 128:	e8 4d 02 00 00       	call   37a <wait>

  exit(0);
 12d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 134:	e8 39 02 00 00       	call   372 <exit>
  return 0;
}
 ...
 145:	e9 2b ff ff ff       	jmp    75 <main+0x75>
...
free(void *ap)
{
 ...
 6c1:	a1 ec 0a 00 00       	mov    0xaec,%eax
{
 ...
 707:	89 10                	mov    %edx,(%eax)
  freep = p;
 709:	a3 ec 0a 00 00       	mov    %eax,0xaec
}
 70e:	5b                   	pop    %ebx
 70f:	5e                   	pop    %esi
 710:	5f                   	pop    %edi
 ...
 72f:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 732:	a3 ec 0a 00 00       	mov    %eax,0xaec
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 759:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 75c:	8b 1d ec 0a 00 00    	mov    0xaec,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 799:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 79b:	3b 15 ec 0a 00 00    	cmp    0xaec,%edx
 ...
 7cd:	e8 ee fe ff ff       	call   6c0 <free>
  return freep;
 7d2:	8b 15 ec 0a 00 00    	mov    0xaec,%edx
 ...
 7f4:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7f7:	89 15 ec 0a 00 00    	mov    %edx,0xaec
      return (void*)(p + 1);
 ...
 80c:	eb e9                	jmp    7f7 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 80e:	c7 05 ec 0a 00 00 f0 	movl   $0xaf0,0xaec
 815:	0a 00 00 
    base.s.size = 0;
 818:	ba f0 0a 00 00       	mov    $0xaf0,%edx
    base.s.ptr = freep = prevp = &base;
 81d:	c7 05 f0 0a 00 00 f0 	movl   $0xaf0,0xaf0
 824:	0a 00 00 
    base.s.size = 0;
 827:	c7 05 f4 0a 00 00 00 	movl   $0x0,0xaf4
 82e:	00 00 00 
