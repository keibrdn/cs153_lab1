   ...
   5:	be 01 00 00 00       	mov    $0x1,%esi
{
  ...
  37:	e8 ee 02 00 00       	call   32a <mkdir>
  3c:	85 c0                	test   %eax,%eax
  3e:	79 e8                	jns    28 <main+0x28>
      printf(2, "mkdir: %s failed to create\n", argv[i]);
  40:	8b 03                	mov    (%ebx),%eax
  42:	c7 44 24 04 9d 07 00 	movl   $0x79d,0x4(%esp)
  49:	00 
 ...
 42e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 54f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 551:	b8 b9 07 00 00       	mov    $0x7b9,%eax
 ...
 611:	a1 4c 0a 00 00       	mov    0xa4c,%eax
{
 ...
 657:	89 10                	mov    %edx,(%eax)
  freep = p;
 659:	a3 4c 0a 00 00       	mov    %eax,0xa4c
}
 65e:	5b                   	pop    %ebx
 65f:	5e                   	pop    %esi
 660:	5f                   	pop    %edi
 ...
 67f:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 682:	a3 4c 0a 00 00       	mov    %eax,0xa4c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 1d 4c 0a 00 00    	mov    0xa4c,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6e9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6eb:	3b 15 4c 0a 00 00    	cmp    0xa4c,%edx
 ...
 71d:	e8 ee fe ff ff       	call   610 <free>
  return freep;
 722:	8b 15 4c 0a 00 00    	mov    0xa4c,%edx
 ...
 744:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 747:	89 15 4c 0a 00 00    	mov    %edx,0xa4c
      return (void*)(p + 1);
 ...
 75c:	eb e9                	jmp    747 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 75e:	c7 05 4c 0a 00 00 50 	movl   $0xa50,0xa4c
 765:	0a 00 00 
    base.s.size = 0;
 768:	ba 50 0a 00 00       	mov    $0xa50,%edx
    base.s.ptr = freep = prevp = &base;
 76d:	c7 05 50 0a 00 00 50 	movl   $0xa50,0xa50
 774:	0a 00 00 
    base.s.size = 0;
 777:	c7 05 54 0a 00 00 00 	movl   $0x0,0xa54
 77e:	00 00 00 
