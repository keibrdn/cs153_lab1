   ...
   6:	bb 01 00 00 00       	mov    $0x1,%ebx
{
  ...
  29:	e8 12 02 00 00       	call   240 <atoi>
  ...
  4f:	c3                   	ret    
    printf(2, "usage: kill pid...\n");
  50:	c7 44 24 04 66 07 00 	movl   $0x766,0x4(%esp)
  57:	00 
  58:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  5f:	e8 9c 03 00 00       	call   400 <printf>
    exit(0);
  64:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  6b:	e8 32 02 00 00       	call   2a2 <exit>
  70:	eb c8                	jmp    3a <main+0x3a>
  72:	66 90                	xchg   %ax,%ax
  74:	66 90                	xchg   %ax,%ax
  76:	66 90                	xchg   %ax,%ax
  78:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 399:	0f b6 92 81 07 00 00 	movzbl 0x781(%edx),%edx
  }while((x /= base) != 0);
 ...
 40e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 52f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 531:	b8 7a 07 00 00       	mov    $0x77a,%eax
