...
main(void)
{
  ...
  31:	00 
  32:	c7 04 24 06 08 00 00 	movl   $0x806,(%esp)
  39:	e8 4c 03 00 00       	call   38a <mknod>
    open("console", O_RDWR);
  3e:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  45:	00 
  46:	c7 04 24 06 08 00 00 	movl   $0x806,(%esp)
  4d:	e8 30 03 00 00       	call   382 <open>
  }
  dup(0);  // stdout
  52:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  59:	8d 5c 24 1c          	lea    0x1c(%esp),%ebx
  5d:	e8 58 03 00 00       	call   3ba <dup>
  dup(0);  // stderr
  62:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  69:	e8 4c 03 00 00       	call   3ba <dup>
  6e:	66 90                	xchg   %ax,%ax

  for(;;){
    printf(1, "init: starting sh\n");
  70:	c7 44 24 04 0e 08 00 	movl   $0x80e,0x4(%esp)
  77:	00 
  78:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  7f:	e8 1c 04 00 00       	call   4a0 <printf>
    pid = fork();
  84:	e8 b1 02 00 00       	call   33a <fork>
    if(pid < 0){
  89:	85 c0                	test   %eax,%eax
    pid = fork();
  8b:	89 44 24 1c          	mov    %eax,0x1c(%esp)
    if(pid < 0){
  8f:	78 65                	js     f6 <main+0xf6>
      printf(1, "init: fork failed\n");
      exit(0);
    }
    if(pid == 0){
  91:	85 c0                	test   %eax,%eax
  93:	74 2b                	je     c0 <main+0xc0>
  ...
  9b:	e8 aa 02 00 00       	call   34a <wait>
  a0:	85 c0                	test   %eax,%eax
  a2:	78 cc                	js     70 <main+0x70>
  a4:	3b 44 24 1c          	cmp    0x1c(%esp),%eax
  a8:	74 c6                	je     70 <main+0x70>
      printf(1, "zombie!\n");
  aa:	c7 44 24 04 4d 08 00 	movl   $0x84d,0x4(%esp)
  b1:	00 
  b2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  b9:	e8 e2 03 00 00       	call   4a0 <printf>
  be:	eb d8                	jmp    98 <main+0x98>
      exec("sh", argv);
  c0:	c7 44 24 04 d4 0a 00 	movl   $0xad4,0x4(%esp)
  c7:	00 
  c8:	c7 04 24 34 08 00 00 	movl   $0x834,(%esp)
  cf:	e8 a6 02 00 00       	call   37a <exec>
      printf(1, "init: exec sh failed\n");
  d4:	c7 44 24 04 37 08 00 	movl   $0x837,0x4(%esp)
  db:	00 
  dc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  e3:	e8 b8 03 00 00       	call   4a0 <printf>
      exit(0);
  e8:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  ef:	e8 4e 02 00 00       	call   342 <exit>
  f4:	eb a2                	jmp    98 <main+0x98>
      printf(1, "init: fork failed\n");
  f6:	c7 44 24 04 21 08 00 	movl   $0x821,0x4(%esp)
  fd:	00 
 ...
 116:	8b 44 24 1c          	mov    0x1c(%esp),%eax
 11a:	e9 72 ff ff ff       	jmp    91 <main+0x91>
 11f:	90                   	nop
