...
free(void *ap)
{
 ...
 5a1:	a1 98 09 00 00       	mov    0x998,%eax
{
 ...
 5e7:	89 10                	mov    %edx,(%eax)
  freep = p;
 5e9:	a3 98 09 00 00       	mov    %eax,0x998
}
 5ee:	5b                   	pop    %ebx
 5ef:	5e                   	pop    %esi
 5f0:	5f                   	pop    %edi
 ...
 60f:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 612:	a3 98 09 00 00       	mov    %eax,0x998
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 1d 98 09 00 00    	mov    0x998,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 679:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 67b:	3b 15 98 09 00 00    	cmp    0x998,%edx
 ...
 6ad:	e8 ee fe ff ff       	call   5a0 <free>
  return freep;
 6b2:	8b 15 98 09 00 00    	mov    0x998,%edx
 ...
 6d4:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6d7:	89 15 98 09 00 00    	mov    %edx,0x998
      return (void*)(p + 1);
 ...
 6ec:	eb e9                	jmp    6d7 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 6ee:	c7 05 98 09 00 00 9c 	movl   $0x99c,0x998
 6f5:	09 00 00 
    base.s.size = 0;
 6f8:	ba 9c 09 00 00       	mov    $0x99c,%edx
    base.s.ptr = freep = prevp = &base;
 6fd:	c7 05 9c 09 00 00 9c 	movl   $0x99c,0x99c
 704:	09 00 00 
    base.s.size = 0;
 707:	c7 05 a0 09 00 00 00 	movl   $0x0,0x9a0
 70e:	00 00 00 
